...
<div
    {{ $attributes->merge(['class' => "$randomClass p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center"]) }}>
    <div class="d-block text-capitalize">
        ...
        <div class="d-flex">
            <p class="mb-0 f-15 font-weight-bold text-indigo d-grid">
